    ...
    <div>
      {session && (
        ...
        <div className="md:absolute md:left-[320px] lg:left-[360px] mt-6 md:pr-8 md:mt-24 w-full md:w-[65vw] lg:w-[75vw]">
          ...
          <div className="grid grid-cols-2 px-4 md:px-0 lg:px-0 gap-4 lg:flex justify-between lg:space-x-6 lg:gap-0">
            <div className="w-full rounded-[20px] px-4 py-4 bg-[#DDEFE0] relative">
              <div className="absolute right-8 top-4">
                <Image src="revenue.svg" alt="revenue" width={20} height={20} />
              </div>
            ...
            <div className="w-full rounded-[20px] px-4 py-4 bg-[#F4ECDD] relative">
              <div className="absolute right-8 top-4">
                <Image src="transactions.svg" alt="revenue" width={20} height={20} />
              </div>
            ...
            <div className="w-full rounded-[20px] px-4 py-4 bg-[#EFDADA] relative">
              <div className="absolute right-8 top-4">
                <Image src="likes.svg" alt="revenue" width={20} height={20} />
              </div>
            ...
            <div className="w-full rounded-[20px] px-4 py-4 bg-[#DEE0EF] relative">
              <div className="absolute right-8 top-4">
                <Image src="users.svg" alt="revenue" width={20} height={20} />
              </div>
          ...
          <div className="md:flex grid justify-between gap-2 md:gap-0 md:space-x-3 pb-4 md:pb-12 px-4 md:px-0">
            <div className="bg-white w-[82vw] md:w-1/2 rounded-[20px] px-[40px] py-4 mr-[40px]">
            ...
            <div className="bg-white w-[82vw] md:w-1/2 rounded-[20px] px-[40px] py-4 mr-[40px]">
              <div className="flex justify-between items-center mb-8">
                ...
                <p className="text-[#858585] font-montserrat md:text-[14px] text-[10px] font-[400]">See all &gt;</p>
              </div>
              <div>
